...
learnmorebtns.forEach((_learnmorebtn, i) => {
  _learnmorebtn.addEventListener("click", () => {
    modal(i);
  });
});
...
// navigation menu items avtive on page scroll
...
// responsiv navigation menu toggle
const menuBtn = document.querySelector(".nav-menu-btn");
const closeBtn = document.querySelector(".nav-close-btn");
const navigation = document.querySelector(".navigation");
const navTtem = document.querySelectorAll(".nav-item a");
...
navTtem.forEach((navTtem) => {
  navTtem.addEventListener("click", () => {
    navigation.classList.remove("active");
  });
});
